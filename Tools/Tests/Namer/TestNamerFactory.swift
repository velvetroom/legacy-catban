...
class TestNamerFactory:XCTestCase {
    func testInjectsViewModel() {
        ...
        let view:PresentingViewProtocol = NamerFactory.makeWith(interactor:MockNamerInteractorProtocol(),
                                                                     and:viewModel)
    ...
    func testInjectsInteractor() {
        ...
        let view:PresentingViewProtocol = NamerFactory.makeWith(interactor:interactor, and:NamerViewModelContent())
        let namer:NamerView<MockNamerInteractorProtocol> = view as! NamerView<MockNamerInteractorProtocol>
