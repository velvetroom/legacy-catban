...
class ViewNotClouded:UIView {
    ...
    private func makeIcon() {
        ...
        icon.image = UIImage(name:ViewConstants.NotCloudedIcon.asset, in:type(of:self))
        self.icon = icon
    ...
    private func makeLabel() {
        ...
        label.font = UIFont.systemFont(ofSize:ViewConstants.NotCloudedTitle.fontSize, weight:UIFont.Weight.regular)
        label.text = String.localized(key:"ViewNotClouded_Label", in:type(of:self))
        self.label = label
    ...
    private func layoutIcon() {
        ...
        self.icon.widthAnchor.constraint(equalToConstant:ViewConstants.NotCloudedIcon.size).isActive = true
        self.icon.heightAnchor.constraint(equalToConstant:ViewConstants.NotCloudedIcon.size).isActive = true
    }
    
    private func layoutLabel() {
        self.label.topAnchor.constraint(equalTo:self.icon.bottomAnchor).isActive = true
        self.label.centerXAnchor.constraint(equalTo:self.centerXAnchor).isActive = true
        self.label.heightAnchor.constraint(equalToConstant:ViewConstants.NotCloudedTitle.height).isActive = true
