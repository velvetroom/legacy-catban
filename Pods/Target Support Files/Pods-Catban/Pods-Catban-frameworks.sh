...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CleanArchitecture/CleanArchitecture.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CodableHero/CodableHero.framework"
